...
class ChunkViewHelper extends AbstractViewHelper
{
     ...
     * @param bool $fixed Whether to allocate items to a fixed number of chunks or not
     * @param bool $preserveKeys If set to true, the original array keys will be preserved in the chunks
     * @throws \Exception
     * @return array
     */
