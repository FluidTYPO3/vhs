...
class ExtractViewHelper extends AbstractViewHelper
{
     ...
     * @param bool $recursive If TRUE, attempts to extract the key from deep nested arrays
     * @param bool $single If TRUE, returns only one value - always the first one - instead of an array of values
     * @return array
     */
