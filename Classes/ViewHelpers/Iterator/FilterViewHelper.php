...
class FilterViewHelper extends AbstractViewHelper
{
     ...
     * @param bool $preserveKeys If TRUE, keys in the array are preserved - even if they are numeric
     * @param bool $invert Invert the behavior of the view helper
     * @param bool $nullFilter If TRUE and $filter is NULL (not set) - to filter NULL or empty values
     *
     * @return mixed
     */
