...
class EncodeViewHelper extends AbstractViewHelper
{
     ...
     * @param bool $useTraversableKeys If TRUE, preserves keys from Traversables converted to arrays. Not recommended for ObjectStorages!
     * @param bool $preventRecursion If FALSE, allows recursion to occur which could potentially be fatal to the output unless managed
    ...
    /**
     * @param string $value
     * @param bool $useTraversableKeys
     * @param bool $preventRecursion
