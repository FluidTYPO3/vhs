...
class NumberViewHelper extends AbstractViewHelper
{
    ...
    /**
     * @param int $minimum Minimum number - defaults to 100000 (max is 999999 making lengths uniform with adequate entropy)
     * @param int $maximum Maximum number - defaults to 999999 (min is 100000 making lengths uniform with adequate entropy)
     * @param int $minimumDecimals Minimum number of also randomized decimal digits to add to number
     * @param int $maximumDecimals Maximum number of also randomized decimal digits to add to number
     * @return float
     */
