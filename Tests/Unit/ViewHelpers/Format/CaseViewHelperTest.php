 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Format_CaseViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Format_CaseViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Format_CaseViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Format_CaseViewHelper', $instance);
	}
