 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Format_Url_SanitizeStringViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Format_Url_SanitizeStringViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Format_Url_SanitizeStringViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Format_Url_SanitizeStringViewHelper', $instance);
	}
