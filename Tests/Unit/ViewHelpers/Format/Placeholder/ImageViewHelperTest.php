 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Format_Placeholder_ImageViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Format_Placeholder_ImageViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Format_Placeholder_ImageViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Format_Placeholder_ImageViewHelper', $instance);
	}
