 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Extension_IconViewHelperTest extends \FluidTYPO3\Vhs\ViewHelpers\AbstractViewHelperTest {
	...
	public function rendersUsingArgument() {
		...
		$this->assertSame(t3lib_extMgm::extPath('vhs', 'ext_icon.gif'), $test);
	}
