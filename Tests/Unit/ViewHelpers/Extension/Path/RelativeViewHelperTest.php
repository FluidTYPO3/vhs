 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Extension_Path_RelativeViewHelperTest extends Tx_Vhs_ViewHelpers_AbstractViewHelperTest {
	...
	public function rendersUsingArgument() {
		...
		$this->assertSame(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('vhs'), $test);
	}
