 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Extension_Path_RelativeViewHelperTest extends \FluidTYPO3\Vhs\ViewHelpers\AbstractViewHelperTest {
	...
	public function rendersUsingArgument() {
		...
		$this->assertSame(t3lib_extMgm::extRelPath('vhs'), $test);
	}
