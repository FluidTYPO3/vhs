 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Extension_Path_ResourcesViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Extension_Path_ResourcesViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Extension_Path_ResourcesViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Extension_Path_ResourcesViewHelper', $instance);
	}
