 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Extension_Path_AbsoluteViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Extension_Path_AbsoluteViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Extension_Path_AbsoluteViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Extension_Path_AbsoluteViewHelper', $instance);
	}
