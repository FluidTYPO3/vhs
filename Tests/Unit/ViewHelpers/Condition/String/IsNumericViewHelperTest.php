...
class IsNumericViewHelperTest extends AbstractViewHelperTest {
	...
	public function rendersThenChildIfConditionMatched() {
		$this->assertEquals('then', $this->executeViewHelper(['then' => 'then', 'else' => 'else', 'value' => '123']));
	}
	...
	public function rendersElseChildIfConditionNotMatched() {
		$this->assertEquals('else', $this->executeViewHelper(['then' => 'then', 'else' => 'else', 'value' => 'z123']));
	}
