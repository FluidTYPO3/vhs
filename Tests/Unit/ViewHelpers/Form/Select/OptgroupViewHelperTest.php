 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Form_Select_OptgroupViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Form_Select_OptgroupViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Form_Select_OptgroupViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Form_Select_OptgroupViewHelper', $instance);
	}
