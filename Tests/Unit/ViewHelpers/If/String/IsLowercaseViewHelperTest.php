 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_String_IsLowercaseViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_String_IsLowercaseViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_String_IsLowercaseViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_String_IsLowercaseViewHelper', $instance);
	}
