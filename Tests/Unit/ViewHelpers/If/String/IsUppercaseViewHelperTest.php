 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_String_IsUppercaseViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_String_IsUppercaseViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_String_IsUppercaseViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_String_IsUppercaseViewHelper', $instance);
	}
