 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_Type_IsInstanceOfViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_Type_IsInstanceOfViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_Type_IsInstanceOfViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_Type_IsInstanceOfViewHelper', $instance);
	}
