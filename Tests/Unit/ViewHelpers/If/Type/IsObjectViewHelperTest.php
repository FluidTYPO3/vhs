 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_Type_IsObjectViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_Type_IsObjectViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_Type_IsObjectViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_Type_IsObjectViewHelper', $instance);
	}
