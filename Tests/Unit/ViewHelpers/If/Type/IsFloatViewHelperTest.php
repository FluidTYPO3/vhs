 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_Type_IsFloatViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_Type_IsFloatViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_Type_IsFloatViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_Type_IsFloatViewHelper', $instance);
	}
