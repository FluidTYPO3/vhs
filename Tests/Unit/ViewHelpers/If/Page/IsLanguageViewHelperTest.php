 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_If_Page_IsLanguageViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_If_Page_IsLanguageViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_If_Page_IsLanguageViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_If_Page_IsLanguageViewHelper', $instance);
	}
