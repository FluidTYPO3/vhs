 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Iterator_IndexOfViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Iterator_IndexOfViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Iterator_IndexOfViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Iterator_IndexOfViewHelper', $instance);
	}
