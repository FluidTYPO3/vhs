 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Iterator_ExplodeViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Iterator_ExplodeViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Iterator_ExplodeViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Iterator_ExplodeViewHelper', $instance);
	}
