 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Once_StandardViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Once_StandardViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Once_StandardViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Once_StandardViewHelper', $instance);
	}
