...
abstract class AbstractViewHelperTestCase extends AbstractTestCase
{
    ...
    protected ?StandardVariableProvider $variableProvider;
    ...
    protected function setUp(): void
    {
        ...
        $this->renderingContext->variableProvider = $this->variableProvider;
    ...
    protected function buildViewHelperInstance(
        ...
        $this->variableProvider->setSource($variables);
    ...
    protected function createViewHelperNode(
        ...
        if (method_exists($node, 'setArguments')) {
            $node->setArguments($arguments);
        } else {
            $this->setInaccessiblePropertyValue($node, 'arguments', $arguments);
        }
