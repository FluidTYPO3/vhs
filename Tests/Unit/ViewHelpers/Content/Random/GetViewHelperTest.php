 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Content_Random_GetViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Content_Random_GetViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Content_Random_GetViewHelper';
		$arguments = array();
