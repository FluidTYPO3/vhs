 ...
 * @package Vhs
 */
class Tx_Vhs_ViewHelpers_Page_AbsoluteUrlViewHelperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @return Tx_Vhs_ViewHelpers_Page_AbsoluteUrlViewHelper
	 * @support
	 */
	protected function getPreparedInstance() {
		$viewHelperClassName = 'Tx_Vhs_ViewHelpers_Page_AbsoluteUrlViewHelper';
		$arguments = array();
	...
	public function canCreateViewHelperClassInstance() {
		...
		$this->assertInstanceOf('Tx_Vhs_ViewHelpers_Page_AbsoluteUrlViewHelper', $instance);
	}
