 ...
 * @package Vhs
 */
class AssetTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function canCreateAssetInstanceFromStaticFileFactoryWithRelativeFileAndTranslatesRelativeToAbsolutePath() {
		...
		$asset = \FluidTYPO3\Vhs\Asset::createFromFile($file);
		$this->assertInstanceOf('FluidTYPO3\Vhs\Asset', $asset);
	...
	public function canCreateAssetInstanceFromStaticFileFactoryWithUrl() {
		$url = 'http://localhost';
		$asset = \FluidTYPO3\Vhs\Asset::createFromUrl($url);
		$this->assertInstanceOf('FluidTYPO3\Vhs\Asset', $asset);
	...
	public function canCreateAssetInstanceFromStaticSettingsFactory() {
		...
		$asset = \FluidTYPO3\Vhs\Asset::createFromSettings($settings);
		$this->assertInstanceOf('FluidTYPO3\Vhs\Asset', $asset);
	}
	...
	public function assertSupportsRawContent() {
		...
		$asset = \FluidTYPO3\Vhs\Asset::createFromContent($content);
	...
	protected function getRelativeAssetFixturePath() {
		$file = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath('vhs') . 'Tests/Fixtures/Files/dummy.js';
		return $file;
	}
	...
	protected function getAbsoluteAssetFixturePath() {
		$file = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('vhs', 'Tests/Fixtures/Files/dummy.js');
		return $file;
	}
